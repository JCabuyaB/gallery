...
var data = {
	categorias: [
		...
		{ id: 'oceania', nombre: 'Oceania', numeroFotos: fotos$1['oceania'].length, imagenPortada: './img/oceania.jpg' },
		{
			id: 'antartida',
			nombre: 'Antártida',
			numeroFotos: fotos$1['antartida'].length,
...
// categorias
const { categorias: categorias$1 } = data;
const contenedorCategorias = document.getElementById("categorias");

categorias$1.forEach((categoria) => {
...
const cargarImagen = (id, nombre, descripcion, ruta) => {
    ...
    galeria$5.querySelector(".galeria__descripcion-imagen-activa").innerText =
        descripcion;
    ...
    const slides = galeria$5.querySelectorAll(".galeria__carousel-slide");
    if (slides.length > 0) {
...
const cargarAnteriorSiguiente = (accion) => {
    let categoriaActual = galeria$5.dataset.categoria;
    let fotosCarousel = fotos[categoriaActual];

    let indexNuevaImagen;

    let idImagenActual = parseInt(
        galeria$5.querySelector(".galeria__imagen").dataset.idImagen
    );
...
categorias.addEventListener("click", (e) => {
    ...
    if (e.target.closest("a")) {
        ...
        // fotos de categoria
        const fotos = data$1.fotos[categoriaActiva];
...
const slideClick = (e) => {
    ...
    data$1.fotos[categoriaActiva].forEach((foto) => {
        if (foto.id === idFoto) {
            id = foto.id;
            nombre = foto.nombre;
...
const carousel = (posicion) => {
    ...
    const observerConfig = {
        root: galeria$2.querySelector(".galeria__carousel-slides"),
        rootMargin: "0px",
        threshold: 0.9,
    };
